 ...
 * (long) IndexInfo.endOpenMarker.localDeletionTime    (if 3.0 && IndexInfo.endOpenMarker != null)
    ...
    public static class Serializer implements ISerializer<IndexInfo>
    {
        ...
        public void serialize(IndexInfo info, DataOutputPlus out) throws IOException
        {
            ...
            if (info.endOpenMarker != null)
            {
                ...
                {
                    DeletionTime.legacySerializer.serialize(info.endOpenMarker, out);
                }
            }
        }
        ...
        public void skip(DataInputPlus in) throws IOException
        {
            ...
            if (in.readBoolean())
            {
                ...
                {
                    DeletionTime.legacySerializer.skip(in);
                }
            }
        }
        ...
        {
            ClusteringPrefix firstName = ClusteringPrefix.serializer.deserialize(in, version.correspondingMessagingVersion(), clusteringTypes);
            ClusteringPrefix lastName = ClusteringPrefix.serializer.deserialize(in, version.correspondingMessagingVersion(), clusteringTypes);
            ...
            if (in.readBoolean())
            {
                ...
                {
                    endOpenMarker = DeletionTime.legacySerializer.deserialize(in);
                }
            }
        ...
        public long serializedSize(IndexInfo info)
        {
            ...
            if (info.endOpenMarker != null)
            {
                ...
                {
                    size += DeletionTime.legacySerializer.serializedSize(info.endOpenMarker);
                }
            }
